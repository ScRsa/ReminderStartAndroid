package ru.scrsa.reminder.dialog;
...
public class AddingTaskDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Spinner spPriority = (Spinner) container.findViewById(R.id.spPriority);

        tilTitle.setHint(getString(R.string.hint_task_title));
        tilDate.setHint(getString(R.string.hint_task_date));
        tilTime.setHint(getString(R.string.hint_task_time));

        builder.setView(container);

        final ModelTask task = new ModelTask();

        ArrayAdapter<String> prioirityAdapter = new ArrayAdapter<String>(getActivity(),
                android.R.layout.simple_spinner_dropdown_item, ModelTask.PRIORITY_LEVELS);

        spPriority.setAdapter(prioirityAdapter);
